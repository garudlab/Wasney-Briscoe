...
parser.add_argument("--use_HMP", help="Passing this flag means the script will use the SNV population frequencies of the HMP cohort to polarize the alleles in this population.", action="store_true")
...
output_file = bz2.open("%ssnps/%s/within_sample_sfs.txt.bz2" % (parse_midas_data.data_directory, species_name),"wt", encoding="utf-8") # MW 07/10/2025: encoding as bytes like object
