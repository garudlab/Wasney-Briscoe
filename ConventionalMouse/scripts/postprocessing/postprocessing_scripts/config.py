...
data_directory = os.path.expanduser("/u/project/ngarud/Garud_lab/ConventionalMouse/midas3_mgbc/merge/")
project_folder = os.path.expanduser("/u/project/ngarud/Garud_lab/ConventionalMouse/midas3_mgbc/")
...
analysis_directory = os.path.expanduser("/u/project/ngarud/michaelw/Diversity-Along-Gut/ConventionalMouse/") #change this for your project
metadata_directory = os.path.expanduser("/u/project/ngarud/michaelw/Diversity-Along-Gut/ConventionalMouse/metadata/")
scripts_directory = os.path.expanduser("/u/project/ngarud/michaelw/Diversity-Along-Gut/ConventionalMouse/scripts/postprocessing/postprocessing_scripts/")
accessions = os.path.expanduser("/u/project/ngarud/michaelw/Diversity-Along-Gut/ConventionalMouse/metadata/accessions.txt") #Needed for creating the strainfinder output
strain_phasing_directory = os.path.expanduser("/u/project/ngarud/Garud_lab/ConventionalMouse/midas3_mgbc/strain_phasing/")

#output
figure_directory = os.path.expanduser("/u/project/ngarud/michaelw/Diversity-Along-Gut/ConventionalMouse/figures/")

#STATIC

midas_directory = os.path.expanduser("/u/scratch/m/michaelw/assembling_mouse_db/MIDASDB-mgbc/")

# We use this one to debug because it was the first one we looked at
debug_species_name = '100334'
