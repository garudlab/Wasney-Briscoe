...
### Directories
#### Input
scripts_directory = os.path.expanduser("/u/project/ngarud/michaelw/microbiome_evolution/microbiome_evolution_SHALON/")
species_directory = os.path.expanduser("/u/project/ngarud/Garud_lab/metagenomic_fastq_files/Shalon_2023/merged_data/species/")
data_directory = os.path.expanduser("/u/project/ngarud/Garud_lab/metagenomic_fastq_files/Shalon_2023/")
merged_directory = os.path.expanduser("/u/project/ngarud/Garud_lab/metagenomic_fastq_files/Shalon_2023/merged_data/")
metadata_directory = os.path.expanduser("/u/project/ngarud/Garud_lab/metagenomic_fastq_files/Shalon_2023/metadata/")
instrain_output_directory = os.path.expanduser("/u/project/ngarud/Garud_lab/metagenomic_fastq_files/Shalon_2023/inStrain/inStrainOutput/")
instrain_compare_directory = os.path.expanduser("/u/project/ngarud/Garud_lab/metagenomic_fastq_files/Shalon_2023/inStrain/inStrainCompare/")
project_folder = os.path.expanduser("/u/project/ngarud/Garud_lab/metagenomic_fastq_files/Shalon_2023/")
instrain_directory = os.path.expanduser("/u/project/ngarud/Garud_lab/metagenomic_fastq_files/Shalon_2023/inStrain/")
analysis_directory = os.path.expanduser("/u/project/ngarud/michaelw/Diversity-Along-Gut/Shalon_2023/")

#SFS_output = os.path.expanduser("/u/project/ngarud/michaelw/PaulAllen/HumanizedMouse_Batch2/SFSs/cov10/")
strainfinder_directory = os.path.expanduser("/u/project/ngarud/Garud_lab/metagenomic_fastq_files/Shalon_2023/strain_phasing/")
#processing_directory = os.path.expanduser("/u/project/ngarud/michaelw/PaulAllen/HumanizedMouse_Batch2/")
