...
plot_strains <- function(species = "Bacteroides_vulgatus_57955", subject = 2, pal =  c("#654321", "#D2B48C"), timepoints_to_use = c(), use_simple_timepoint = FALSE, brief_x_labels = TRUE, path = "/u/project/ngarud/Garud_lab/metagenomic_fastq_files/Shalon_2023/strain_phasing/strain_freqs.csv") {
