...
def load_intersample_change_map(species_name, all_changes = False):
    ...
    if all_changes:
        intersample_change_directory = '%sintersample_change_all/' % (parse_midas_data.data_directory) #MW 12/05/23: load the delta f file if that's the analysis
    else:
        intersample_change_directory = '%sintersample_change/' % (parse_midas_data.data_directory)
...
if __name__=='__main__':
    ...
    if all_changes:
        intersample_change_directory = '%sintersample_change_all/' % (parse_midas_data.data_directory) #MW 11/28/23: write the delta f file if that's the analysis
    else:
        intersample_change_directory = '%sintersample_change/' % (parse_midas_data.data_directory)
