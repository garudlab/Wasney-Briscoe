...
if __name__=='__main__':
    ...
    parser.add_argument("--use_HMP", help="Use HMP-polarized within-person SFS", action = "store_true")
    ...
    for species_name in good_species_list:
        ...
        if use_HMP:
            snp_samples = diversity_utils.calculate_haploid_samples(species_name, debug=debug, use_HMP = True)
        else:
