...
def load_all_sample_pairs(snp_samples = []):
    ...
    upper_array = numpy.array(sample_pairs_upper, dtype=numpy.str)
    lower_array = numpy.array(sample_pairs_lower, dtype=numpy.str)
    ...
    for pair_idx in xrange(0,len(combined_sample_array[0])):
