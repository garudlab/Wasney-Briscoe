...
project_directory = os.path.expanduser("/u/project/ngarud/Garud_lab/HumanizedMouse/HumanizedMouse_Batch2/")
snps_directory = os.path.expanduser("%s/snps" % data_directory)
analysis_directory = os.path.expanduser("/u/project/ngarud/michaelw/Diversity-Along-Gut/HumanizedMouse/scripts/strain_phasing/")
scripts_directory = analysis_directory
strain_phasing_directory = os.path.expanduser("/u/project/ngarud/Garud_lab/HumanizedMouse/HumanizedMouse_Batch2/strain_phasing/")
figure_directory = os.path.expanduser("/u/project/ngarud/michaelw/Diversity-Along-Gut/HumanizedMouse/figures/")
strain_cluster_directory =  os.path.expanduser("/u/project/ngarud/Garud_lab/HumanizedMouse/HumanizedMouse_Batch2/strain_phasing/")
...
debug_species_name = 'Prevotella_copri_61740'
